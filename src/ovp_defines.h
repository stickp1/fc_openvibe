...
#define OVP_TypeId_Algorithm_CorrectedImaginaryPhaseLockingValue                         OpenViBE::CIdentifier(0x986878AE, 0x0F21C1E5)
#define OVP_TypeId_Algorithm_CorrectedImaginaryPhaseLockingValueDesc                     OpenViBE::CIdentifier(0x37EF169D, 0x92FFC8D7)
...
#define OVP_TypeId_Algorithm_WeightedPhaseLagIndex                                      OpenViBE::CIdentifier(0xA8934E67, 0xD72FA751)
#define OVP_TypeId_Algorithm_WeightedPhaseLagIndexDesc                                  OpenViBE::CIdentifier(0x685C3A8D, 0x4A3AEC61)
...
#define OVP_TypeId_Algorithm_ImCoherence                    			 OpenViBE::CIdentifier(0x2FEA1DBC, 0x90234404)
#define OVP_TypeId_Algorithm_ImCoherenceDesc                			 OpenViBE::CIdentifier(0x5EE5DEA6, 0x8E158D35)
#define OVP_Algorithm_ImCoherence_InputParameterId_SegLength			 OpenViBE::CIdentifier(0xA330FF56, 0x60F7956F)
#define OVP_Algorithm_ImCoherence_InputParameterId_Overlap    			 OpenViBE::CIdentifier(0x0D72DC85, 0x88530DAA)
#define OVP_Algorithm_ImCoherence_InputParameterId_Window			     OpenViBE::CIdentifier(0x4C784FF2, 0x9073A28D)
#define OVP_Algorithm_ImCoherence_InputParameterId_Nfft	     			 OpenViBE::CIdentifier(0xF62DFDE7, 0x9809060C)
#define OVP_Algorithm_ImCoherence_OutputParameterId_OutputMatrixSpectrum OpenViBE::CIdentifier(0x523FF3E0, 0x93523DAA)
#define OVP_Algorithm_ImCoherence_OutputParameterId_FreqVector           OpenViBE::CIdentifier(0x68E96D76, 0xBA6E98D3)

#define OVP_TypeId_Algorithm_PhaseSlopeIndex                                   OpenViBE::CIdentifier(0xF74052C2, 0x419F91BD)
#define OVP_TypeId_Algorithm_PhaseSlopeIndexDesc                               OpenViBE::CIdentifier(0x4058C601, 0x4A934C7D)
#define OVP_Algorithm_PhaseSlopeIndex_InputParameterId_SegLength               OpenViBE::CIdentifier(0x6669BE39, 0x75DBB4F5)
#define OVP_Algorithm_PhaseSlopeIndex_InputParameterId_Overlap                 OpenViBE::CIdentifier(0xCD844516, 0x747382E5)
#define OVP_Algorithm_PhaseSlopeIndex_InputParameterId_Window                  OpenViBE::CIdentifier(0x003D6A9A, 0x882BB769)
#define OVP_Algorithm_PhaseSlopeIndex_InputParameterId_Nfft     		     OpenViBE::CIdentifier(0x06E53CFC, 0xCAB37AF8)
#define OVP_Algorithm_PhaseSlopeIndex_OutputParameterId_OutputMatrixSpectrum   OpenViBE::CIdentifier(0xEB6718A8, 0x6B519FFC)
#define OVP_Algorithm_PhaseSlopeIndex_OutputParameterId_FreqVector             OpenViBE::CIdentifier(0x79496B38, 0x9363708A)
#define OVP_Algorithm_PhaseSlopeIndex_InputParameterId_FreqWindow              OpenViBE::CIdentifier(0x6A4BF11D, 0x5B8B3C46)
